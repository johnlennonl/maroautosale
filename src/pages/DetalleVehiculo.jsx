  ...
  if (!vehicle) {
    return (
      <div className="min-h-screen pt-24 text-center dark:text-white bg-black p-8">
        ...
        <p className="text-lg text-neutral-400">El ID {id} no corresponde a ningún vehículo en nuestro inventario.</p>
        <Link to="/inventario" className="mt-6 inline-block text-blue-500 hover:text-blue-400">
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-black py-10 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <Link to="/inventario" className="text-blue-500 hover:text-blue-400 font-semibold mb-6 inline-block">
          ← Volver a la Lista
        </Link>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          <div className="lg:col-span-2">
            <VehicleGallery mainImageUrl={vehicle.imagenUrl} />
            
            <div className="mt-8 p-6 bg-white dark:bg-neutral-800 rounded-xl shadow-lg dark:shadow-none border dark:border-neutral-700">
                <h2 className="text-2xl font-bold dark:text-white mb-4">Descripción General</h2>
                <p className="text-gray-700 dark:text-neutral-300">
                    {vehicle.descripcionCorta} (Aquí iría una descripción mucho más detallada sobre el motor, historial y estado del vehículo).
                </p>
            </div>
          </div>
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="p-6 bg-white dark:bg-neutral-800 rounded-xl shadow-2xl border-l-4 border-blue-600 dark:border-blue-400">
                <p className="text-sm font-semibold text-gray-600 dark:text-neutral-400">Precio de Venta</p>
                ...
                <Link to="/contacto" className="block text-center mt-3 text-sm text-gray-600 dark:text-neutral-400 hover:text-gray-800 dark:hover:text-neutral-200">
            ...
            <div className="p-6 bg-white dark:bg-neutral-800 rounded-xl shadow-lg dark:shadow-none border dark:border-neutral-700">
                <h2 className="text-2xl font-bold dark:text-white mb-4">Ficha Técnica</h2>
                <ul className="space-y-3 dark:text-neutral-300">
                    <li className="flex justify-between border-b border-neutral-200 dark:border-neutral-700 pb-2">
                        <span className="font-medium">Marca / Modelo:</span> <span>{vehicle.marca} {vehicle.modelo}</span>
                    </li>
                    <li className="flex justify-between border-b border-neutral-200 dark:border-neutral-700 pb-2">
                        <span className="font-medium">Año:</span> <span>{vehicle.año}</span>
                    </li>
                    <li className="flex justify-between border-b border-neutral-200 dark:border-neutral-700 pb-2">
                        <span className="font-medium">Kilometraje:</span> <span>{vehicle.kilometraje.toLocaleString('es-ES')} km</span>
                    </li>
